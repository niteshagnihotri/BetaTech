    ...
    const handleSubmit = async (e) =>{
        ...
        await fetch('/driver_login', {
            ...
            if (res.status === 400) {
                ...
                // history("/");
                setTimeout(()=>{
                    var drivertoken = Cookies.get('drivertoken');
                    if(drivertoken){
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <Link to="/driver_register" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</Link>
                  </p>
              </form>
          </div>
      </div>
